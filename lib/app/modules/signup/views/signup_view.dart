                ...
                child: Container(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        SizedBox(height: 35,),
                        Text("Daftar",style: normalBold.copyWith(fontSize: 28,color: Colors.white),),
                        SizedBox(height: 25,),
                        Text("Nama",style: smallBold.copyWith(color: Colors.white),),
                        SizedBox(height: 10,),
                        TextField(
                        ...
                        SizedBox(height: 25,),
                        Text("Email",style: smallBold.copyWith(color: Colors.white),),
                        SizedBox(height: 10,),
                        TextField(
                        ...
                        SizedBox(height: 25,),
                        Text("Password",style: smallBold.copyWith(color: Colors.white),),
                        SizedBox(height: 10,),
                        TextField(
                          obscureText: true,
                          decoration: InputDecoration(
                        ...
                        Center(
                          child: Container(
                            ...
                            child: ElevatedButton(
                              ...
                              child: Text(
                                "Daftar",
                                style: smallSemibold.copyWith(color: Color(0xFF254E7A)),
                              ),
                            ),
                          ),
                        )
